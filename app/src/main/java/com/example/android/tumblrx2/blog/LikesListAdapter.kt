...
import com.example.android.tumblrx2.responses.likes.LikePost
...
class LikesListAdapter(context:Context,posts:List<LikePost>): BaseAdapter() {
    ...
    override fun getItem(position: Int): LikePost {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val post:LikePost = getItem(position)
