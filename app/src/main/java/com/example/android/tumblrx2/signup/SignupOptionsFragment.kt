...
class SignupOptionsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val signupWithEmailButton = getView()?.findViewById<Button>(R.id.btn_signup_email)
        signupWithEmailButton?.setOnClickListener {
//            val fragmentTransaction = parentFragmentManager.beginTransaction().apply{
            Intent(this@SignupOptionsFragment.context, SignupActivity::class.java).also {
                startActivity(it)
            }
        }
    }
